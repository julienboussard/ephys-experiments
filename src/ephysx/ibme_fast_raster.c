...
{
    "distutils": {
        "name": "spike_psvae.ibme_fast_raster",
        "sources": [
            "spike_psvae/ibme_fast_raster.pyx"
        ]
    },
    "module_name": "spike_psvae.ibme_fast_raster"
}
END: Cython Metadata */
...
#define __PYX_HAVE__spike_psvae__ibme_fast_raster
#define __PYX_HAVE_API__spike_psvae__ibme_fast_raster
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'spike_psvae.ibme_fast_raster' */
...
#define __Pyx_MODULE_NAME "spike_psvae.ibme_fast_raster"
extern int __pyx_module_is_main_spike_psvae__ibme_fast_raster;
int __pyx_module_is_main_spike_psvae__ibme_fast_raster = 0;

/* Implementation of 'spike_psvae.ibme_fast_raster' */
...
static const char __pyx_k_spike_psvae_ibme_fast_raster[] = "spike_psvae.ibme_fast_raster";
...
static const char __pyx_k_spike_psvae_ibme_fast_raster_pyx[] = "spike_psvae/ibme_fast_raster.pyx";
...
static PyObject *__pyx_n_s_spike_psvae_ibme_fast_raster;
static PyObject *__pyx_kp_s_spike_psvae_ibme_fast_raster_pyx;
...
static PyObject *__pyx_pf_11spike_psvae_16ibme_fast_raster_raster(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_times, __Pyx_memviewslice __pyx_v_depths, __Pyx_memviewslice __pyx_v_amps, __Pyx_memviewslice __pyx_v_M, __Pyx_memviewslice __pyx_v_N); /* proto */
...
/* "spike_psvae/ibme_fast_raster.pyx":10
...
/* Python wrapper */
static PyObject *__pyx_pw_11spike_psvae_16ibme_fast_raster_1raster(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_11spike_psvae_16ibme_fast_raster_1raster = {"raster", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11spike_psvae_16ibme_fast_raster_1raster, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_11spike_psvae_16ibme_fast_raster_1raster(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_times,&__pyx_n_s_depths,&__pyx_n_s_amps,&__pyx_n_s_M,&__pyx_n_s_N,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_depths)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("raster", 1, 5, 5, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_amps)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("raster", 1, 5, 5, 2); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_M)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("raster", 1, 5, 5, 3); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("raster", 1, 5, 5, 4); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "raster") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
    ...
    __pyx_v_times = __Pyx_PyObject_to_MemoryviewSlice_dc_double__const__(values[0], 0); if (unlikely(!__pyx_v_times.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_depths = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_depths.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_amps = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_amps.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_M = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_M.memview)) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_N = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_N.memview)) __PYX_ERR(0, 15, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("raster", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("spike_psvae.ibme_fast_raster.raster", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11spike_psvae_16ibme_fast_raster_raster(__pyx_self, __pyx_v_times, __pyx_v_depths, __pyx_v_amps, __pyx_v_M, __pyx_v_N);
...
static PyObject *__pyx_pf_11spike_psvae_16ibme_fast_raster_raster(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_times, __Pyx_memviewslice __pyx_v_depths, __Pyx_memviewslice __pyx_v_amps, __Pyx_memviewslice __pyx_v_M, __Pyx_memviewslice __pyx_v_N) {
  int __pyx_v_j;
  ...
  /* "spike_psvae/ibme_fast_raster.pyx":17
 *     double[:, :] N,
 * ):
 *     print("ok")             # <<<<<<<<<<<<<<
 *     cdef int j
 ...
 */
  ...
  /* "spike_psvae/ibme_fast_raster.pyx":19
 *     print("ok")
 *     cdef int j
 *     cdef Py_ssize_t S = times.shape[0]             # <<<<<<<<<<<<<<
 * 
 *     for j in range(S):
 */
  __pyx_v_S = (__pyx_v_times.shape[0]);

  /* "spike_psvae/ibme_fast_raster.pyx":21
 *     cdef Py_ssize_t S = times.shape[0]
 * 
 *     for j in range(S):             # <<<<<<<<<<<<<<
 *         idj = <int> depths[j]
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "spike_psvae/ibme_fast_raster.pyx":22
 * 
 *     for j in range(S):
 *         idj = <int> depths[j]             # <<<<<<<<<<<<<<
 *         itj = <int> times[j]
 ...
 */
    ...
    __pyx_t_6 = -1;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_depths.shape[0];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_depths.shape[0])) __pyx_t_6 = 0;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      __PYX_ERR(0, 22, __pyx_L1_error)
    }
    __pyx_v_idj = ((int)(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_depths.data) + __pyx_t_5)) ))));

    /* "spike_psvae/ibme_fast_raster.pyx":23
 *     for j in range(S):
 *         idj = <int> depths[j]
 *         itj = <int> times[j]             # <<<<<<<<<<<<<<
 *         M[idj, itj] += amps[j]
 ...
 */
    ...
    __pyx_t_6 = -1;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_times.shape[0];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_times.shape[0])) __pyx_t_6 = 0;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      __PYX_ERR(0, 23, __pyx_L1_error)
    }
    __pyx_v_itj = ((int)(*((double const  *) ( /* dim=0 */ ((char *) (((double const  *) __pyx_v_times.data) + __pyx_t_5)) ))));

    /* "spike_psvae/ibme_fast_raster.pyx":24
 *         idj = <int> depths[j]
 *         itj = <int> times[j]
 *         M[idj, itj] += amps[j]             # <<<<<<<<<<<<<<
 *         N[idj, itj] += 1
 */
    ...
    __pyx_t_6 = -1;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_amps.shape[0];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_amps.shape[0])) __pyx_t_6 = 0;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      __PYX_ERR(0, 24, __pyx_L1_error)
    }
    __pyx_t_7 = __pyx_v_idj;
    __pyx_t_8 = __pyx_v_itj;
    __pyx_t_6 = -1;
    if (__pyx_t_7 < 0) {
      __pyx_t_7 += __pyx_v_M.shape[0];
      if (unlikely(__pyx_t_7 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_7 >= __pyx_v_M.shape[0])) __pyx_t_6 = 0;
    if (__pyx_t_8 < 0) {
      __pyx_t_8 += __pyx_v_M.shape[1];
      if (unlikely(__pyx_t_8 < 0)) __pyx_t_6 = 1;
    } else if (unlikely(__pyx_t_8 >= __pyx_v_M.shape[1])) __pyx_t_6 = 1;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      __PYX_ERR(0, 24, __pyx_L1_error)
    }
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_M.data + __pyx_t_7 * __pyx_v_M.strides[0]) ) + __pyx_t_8 * __pyx_v_M.strides[1]) )) += (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_amps.data) + __pyx_t_5)) )));

    /* "spike_psvae/ibme_fast_raster.pyx":25
 *         itj = <int> times[j]
 *         M[idj, itj] += amps[j]
 *         N[idj, itj] += 1             # <<<<<<<<<<<<<<
 */
    __pyx_t_5 = __pyx_v_idj;
    __pyx_t_8 = __pyx_v_itj;
    __pyx_t_6 = -1;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_N.shape[0];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_N.shape[0])) __pyx_t_6 = 0;
    if (__pyx_t_8 < 0) {
      __pyx_t_8 += __pyx_v_N.shape[1];
      if (unlikely(__pyx_t_8 < 0)) __pyx_t_6 = 1;
    } else if (unlikely(__pyx_t_8 >= __pyx_v_N.shape[1])) __pyx_t_6 = 1;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      __PYX_ERR(0, 25, __pyx_L1_error)
    }
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_N.data + __pyx_t_5 * __pyx_v_N.strides[0]) ) + __pyx_t_8 * __pyx_v_N.strides[1]) )) += 1.0;
  }
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "spike_psvae.ibme_fast_raster.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "spike_psvae.ibme_fast_raster.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "spike_psvae.ibme_fast_raster.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "spike_psvae.ibme_fast_raster._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_ibme_fast_raster(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ibme_fast_raster},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_spike_psvae_ibme_fast_raster, __pyx_k_spike_psvae_ibme_fast_raster, sizeof(__pyx_k_spike_psvae_ibme_fast_raster), 0, 0, 1, 1},
  {&__pyx_kp_s_spike_psvae_ibme_fast_raster_pyx, __pyx_k_spike_psvae_ibme_fast_raster_pyx, sizeof(__pyx_k_spike_psvae_ibme_fast_raster_pyx), 0, 0, 1, 0},
 ...
 *     cdef Py_ssize_t S = times.shape[0]
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_n_u_ok); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 17, __pyx_L1_error)
 ...
 *     double[::1] depths,
 */
  __pyx_tuple__20 = PyTuple_Pack(9, __pyx_n_s_times, __pyx_n_s_depths, __pyx_n_s_amps, __pyx_n_s_M, __pyx_n_s_N, __pyx_n_s_j, __pyx_n_s_S, __pyx_n_s_idj, __pyx_n_s_itj); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(5, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_spike_psvae_ibme_fast_raster_pyx, __pyx_n_s_raster, 10, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 10, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initibme_fast_raster(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initibme_fast_raster(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_ibme_fast_raster(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_ibme_fast_raster(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ibme_fast_raster(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ibme_fast_raster' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_ibme_fast_raster(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ibme_fast_raster", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_spike_psvae__ibme_fast_raster) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "spike_psvae.ibme_fast_raster")) {
      if (unlikely(PyDict_SetItemString(modules, "spike_psvae.ibme_fast_raster", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "spike_psvae/ibme_fast_raster.pyx":3
 * #!python
 ...
 *     double[::1] depths,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_11spike_psvae_16ibme_fast_raster_1raster, NULL, __pyx_n_s_spike_psvae_ibme_fast_raster); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_raster, __pyx_t_1) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "spike_psvae/ibme_fast_raster.pyx":1
 * #!python             # <<<<<<<<<<<<<<
 * #cython: language_level=3
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init spike_psvae.ibme_fast_raster", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init spike_psvae.ibme_fast_raster");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
